...
class TestEndpointsApi(unittest.TestCase):
    ...
    def test_bikedirections(self):
        """Test case for bikedirections

        Bike directions between two points (hire vehicles)  # noqa: E501
        """
        pass

    def test_bikeridedirections(self):
        """Test case for bikeridedirections

        Bike directions between two points (ride only)  # noqa: E501
        """
        pass

    def test_liverouteupdates(self):
        """Test case for liverouteupdates

        Live departure and availability information for multiple Routes at once  # noqa: E501
        """
        pass

    def test_motorscooterdirections(self):
        """Test case for motorscooterdirections

        Motor scooter directions between two points (hire vehicles)  # noqa: E501
        """
        pass

    def test_motorscooterridedirections(self):
        """Test case for motorscooterridedirections

        Motor scooter directions between two points (ride only)  # noqa: E501
        """
        pass

    def test_scenariodirections(self):
        """Test case for scenariodirections

        Scenario based directions between two points  # noqa: E501
        """
        pass

    def test_scooterdirections(self):
        """Test case for scooterdirections

        E-scooter directions between two points (hire vehicles)  # noqa: E501
        """
        pass

    def test_scooterridedirections(self):
        """Test case for scooterridedirections

        E-scooter directions between two points (ride only)  # noqa: E501
        """
        pass

    def test_transitdirections(self):
        """Test case for transitdirections
    ...
    def test_walkdirections(self):
        """Test case for walkdirections
