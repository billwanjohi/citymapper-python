...
class LegVariantTransitBestBoardingSections(object):
    ...
    def __init__(self, front=False, middle=False, back=False):  # noqa: E501
        """LegVariantTransitBestBoardingSections - a model defined in Swagger"""  # noqa: E501
        self._front = None
        self._middle = None
        self._back = None
    ...
    @property
    def front(self):
        """Gets the front of this LegVariantTransitBestBoardingSections.  # noqa: E501

        When `true`, this indicates that the rider should board near the front of the train to be close to an exit at the destination platform.   # noqa: E501

        :return: The front of this LegVariantTransitBestBoardingSections.  # noqa: E501
        :rtype: bool
        """
        return self._front
    ...
    def front(self, front):
        """Sets the front of this LegVariantTransitBestBoardingSections.

        When `true`, this indicates that the rider should board near the front of the train to be close to an exit at the destination platform.   # noqa: E501

        :param front: The front of this LegVariantTransitBestBoardingSections.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def middle(self):
        """Gets the middle of this LegVariantTransitBestBoardingSections.  # noqa: E501

        When `true`, this indicates that the rider should board near the middle of the train to be close to an exit at the destination platform.   # noqa: E501

        :return: The middle of this LegVariantTransitBestBoardingSections.  # noqa: E501
        :rtype: bool
        """
        return self._middle
    ...
    def middle(self, middle):
        """Sets the middle of this LegVariantTransitBestBoardingSections.

        When `true`, this indicates that the rider should board near the middle of the train to be close to an exit at the destination platform.   # noqa: E501

        :param middle: The middle of this LegVariantTransitBestBoardingSections.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def back(self):
        """Gets the back of this LegVariantTransitBestBoardingSections.  # noqa: E501

        When `true`, this indicates that the rider should board near the back of the train to be close to an exit at the destination platform.   # noqa: E501

        :return: The back of this LegVariantTransitBestBoardingSections.  # noqa: E501
        :rtype: bool
        """
        return self._back
    ...
    @back.setter
    def back(self, back):
        """Sets the back of this LegVariantTransitBestBoardingSections.

        When `true`, this indicates that the rider should board near the back of the train to be close to an exit at the destination platform.   # noqa: E501

        :param back: The back of this LegVariantTransitBestBoardingSections.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LegVariantTransitBestBoardingSections, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LegVariantTransitBestBoardingSections):
            return False
