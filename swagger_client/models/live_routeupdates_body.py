...
class LiveRouteupdatesBody(object):
    ...
    def __init__(self, signatures=None):  # noqa: E501
        """LiveRouteupdatesBody - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def signatures(self):
        """Gets the signatures of this LiveRouteupdatesBody.  # noqa: E501

        An array of `signature` properties from previously-obtained Routes  # noqa: E501

        :return: The signatures of this LiveRouteupdatesBody.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def signatures(self, signatures):
        """Sets the signatures of this LiveRouteupdatesBody.

        An array of `signature` properties from previously-obtained Routes  # noqa: E501

        :param signatures: The signatures of this LiveRouteupdatesBody.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LiveRouteupdatesBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LiveRouteupdatesBody):
            return False
