...
import six
from swagger_client.models.station_exit import StationExit  # noqa: F401,E501

class AllOfStationWalkDetailsRecommendedExit(StationExit):
    ...
    if hasattr(StationExit, "swagger_types"):
        swagger_types.update(StationExit.swagger_types)

    attribute_map = {
    }
    if hasattr(StationExit, "attribute_map"):
        attribute_map.update(StationExit.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfStationWalkDetailsRecommendedExit - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        StationExit.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfStationWalkDetailsRecommendedExit, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfStationWalkDetailsRecommendedExit):
            return False
