...
import six
from swagger_client.models.coordinates import Coordinates  # noqa: F401,E501

class AllOfStationExitCoordinates(Coordinates):
    ...
    if hasattr(Coordinates, "swagger_types"):
        swagger_types.update(Coordinates.swagger_types)

    attribute_map = {
    }
    if hasattr(Coordinates, "attribute_map"):
        attribute_map.update(Coordinates.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfStationExitCoordinates - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfStationExitCoordinates, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfStationExitCoordinates):
            return False
