...
class RouteMetadata(object):
    ...
    def __init__(self, groups=None, profile_name=None):  # noqa: E501
        """RouteMetadata - a model defined in Swagger"""  # noqa: E501
        self._groups = None
    ...
    @property
    def groups(self):
        """Gets the groups of this RouteMetadata.  # noqa: E501


        :return: The groups of this RouteMetadata.  # noqa: E501
    ...
    def groups(self, groups):
        """Sets the groups of this RouteMetadata.


        :param groups: The groups of this RouteMetadata.  # noqa: E501
        :type: list[RouteGroup]
        """
    ...
    def profile_name(self):
        """Gets the profile_name of this RouteMetadata.  # noqa: E501

        Human-readable localized name of the `profile` identifier. For example, if a response has `\"language\": \"de-DE\"`, `profile` in a walk Route object may be `\"main_roads\"` and this localized `profile_name` will be `\"Hauptstraßen\"`.   # noqa: E501

        :return: The profile_name of this RouteMetadata.  # noqa: E501
        :rtype: str
        """
    ...
    def profile_name(self, profile_name):
        """Sets the profile_name of this RouteMetadata.

        Human-readable localized name of the `profile` identifier. For example, if a response has `\"language\": \"de-DE\"`, `profile` in a walk Route object may be `\"main_roads\"` and this localized `profile_name` will be `\"Hauptstraßen\"`.   # noqa: E501

        :param profile_name: The profile_name of this RouteMetadata.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RouteMetadata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RouteMetadata):
            return False
