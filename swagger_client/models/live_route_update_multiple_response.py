...
class LiveRouteUpdateMultipleResponse(object):
    ...
    def __init__(self, route_updates=None):  # noqa: E501
        """LiveRouteUpdateMultipleResponse - a model defined in Swagger"""  # noqa: E501
        self._route_updates = None
        self.discriminator = None
        self.route_updates = route_updates

    @property
    def route_updates(self):
        """Gets the route_updates of this LiveRouteUpdateMultipleResponse.  # noqa: E501


        :return: The route_updates of this LiveRouteUpdateMultipleResponse.  # noqa: E501
        :rtype: list[RouteUpdate]
        """
        return self._route_updates

    @route_updates.setter
    def route_updates(self, route_updates):
        """Sets the route_updates of this LiveRouteUpdateMultipleResponse.


        :param route_updates: The route_updates of this LiveRouteUpdateMultipleResponse.  # noqa: E501
        :type: list[RouteUpdate]
        """
        if route_updates is None:
            raise ValueError("Invalid value for `route_updates`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LiveRouteUpdateMultipleResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LiveRouteUpdateMultipleResponse):
            return False
