...
class Brand(object):
    ...
    def __init__(self, id=None, name=None, images=None):  # noqa: E501
    ...
    def id(self):
        ...
        The identifier for this Brand  # noqa: E501
