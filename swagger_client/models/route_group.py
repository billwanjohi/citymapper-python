...
class RouteGroup(object):
    ...
    def __init__(self, group_id=None, group_name=None, route_position=None):  # noqa: E501
    ...
    @property
    def group_id(self):
        """Gets the group_id of this RouteGroup.  # noqa: E501

        ID of a group a Route contains in.  # noqa: E501

        :return: The group_id of this RouteGroup.  # noqa: E501
        :rtype: str
        """
    ...
    def group_id(self, group_id):
        """Sets the group_id of this RouteGroup.

        ID of a group a Route contains in.  # noqa: E501

        :param group_id: The group_id of this RouteGroup.  # noqa: E501
        :type: str
        """
        if group_id is None:
    ...
    @property
    def group_name(self):
        """Gets the group_name of this RouteGroup.  # noqa: E501

        Localised name of a Route group, e.g. 'Transit' or 'Le métro'.  # noqa: E501

        :return: The group_name of this RouteGroup.  # noqa: E501
        :rtype: str
        """
    ...
    def group_name(self, group_name):
        """Sets the group_name of this RouteGroup.

        Localised name of a Route group, e.g. 'Transit' or 'Le métro'.  # noqa: E501

        :param group_name: The group_name of this RouteGroup.  # noqa: E501
        :type: str
        """
    ...
    @property
    def route_position(self):
        """Gets the route_position of this RouteGroup.  # noqa: E501

        A zero-based position of a Route within specific group.  # noqa: E501

        :return: The route_position of this RouteGroup.  # noqa: E501
        :rtype: int
        """
        return self._route_position

    @route_position.setter
    def route_position(self, route_position):
        """Sets the route_position of this RouteGroup.

        A zero-based position of a Route within specific group.  # noqa: E501

        :param route_position: The route_position of this RouteGroup.  # noqa: E501
        :type: int
        """
        if route_position is None:
            raise ValueError("Invalid value for `route_position`, must not be `None`")  # noqa: E501

        self._route_position = route_position
