...
class LiveRouteUpdateResponse(object):
    ...
    def __init__(self, route_update=None):  # noqa: E501
        """LiveRouteUpdateResponse - a model defined in Swagger"""  # noqa: E501
        self._route_update = None
        self.discriminator = None
        self.route_update = route_update

    @property
    def route_update(self):
        """Gets the route_update of this LiveRouteUpdateResponse.  # noqa: E501


        :return: The route_update of this LiveRouteUpdateResponse.  # noqa: E501
        :rtype: RouteUpdate
        """
        return self._route_update

    @route_update.setter
    def route_update(self, route_update):
        """Sets the route_update of this LiveRouteUpdateResponse.


        :param route_update: The route_update of this LiveRouteUpdateResponse.  # noqa: E501
        :type: RouteUpdate
        """
        if route_update is None:
            raise ValueError("Invalid value for `route_update`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LiveRouteUpdateResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LiveRouteUpdateResponse):
            return False
