...
class GatewayError(object):
    ...
    def __init__(self, message=None):  # noqa: E501
        """GatewayError - a model defined in Swagger"""  # noqa: E501
        self._message = None
    ...
    @property
    def message(self):
        """Gets the message of this GatewayError.  # noqa: E501

        A developer-readable message explaining the problem. Must not be displayed to the end user.  # noqa: E501

        :return: The message of this GatewayError.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        ...
        :param message: The message of this GatewayError.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GatewayError, dict):
